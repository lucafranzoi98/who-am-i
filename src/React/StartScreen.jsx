...
export default function StartScreen() {
   return <>
      ...
      <span className="credits absolute text-sm text-neutral-500 bottom-0 left-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap pb-1">A project by Luca Franzoi</span>
   </>
}